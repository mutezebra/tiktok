...
func (p *InteractionServiceClient) Like(ctx context.Context, req *LikeReq) (r *LikeResp, err error) {
...
func (p *InteractionServiceClient) Dislike(ctx context.Context, req *DislikeReq) (r *DislikeResp, err error) {
	var _args InteractionServiceDislikeArgs
	_args.Req = req
	var _result InteractionServiceDislikeResult
	if err = p.Client_().Call(ctx, "Dislike", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *InteractionServiceClient) Comment(ctx context.Context, req *CommentReq) (r *CommentResp, err error) {
...
func NewInteractionServiceProcessor(handler InteractionService) *InteractionServiceProcessor {
	...
	self.AddToProcessorMap("Dislike", &interactionServiceProcessorDislike{handler: handler})
...
type interactionServiceProcessorDislike struct {
	handler InteractionService
}

func (p *interactionServiceProcessorDislike) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := InteractionServiceDislikeArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("Dislike", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := InteractionServiceDislikeResult{}
	var retval *DislikeResp
	if retval, err2 = p.handler.Dislike(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing Dislike: "+err2.Error())
		oprot.WriteMessageBegin("Dislike", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("Dislike", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *InteractionServiceDislikeArgs) InitDefault() {
	*p = InteractionServiceDislikeArgs{}
}
...
func (p *InteractionServiceDislikeResult) InitDefault() {
	*p = InteractionServiceDislikeResult{}
}
...
func (p *InteractionServiceCommentArgs) InitDefault() {
	*p = InteractionServiceCommentArgs{}
}
...
func (p *InteractionServiceCommentResult) InitDefault() {
	*p = InteractionServiceCommentResult{}
}
