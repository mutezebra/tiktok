...
type CreateChatGroupReq struct {
	GroupName *string `thrift:"GroupName,1,optional" frugal:"1,optional,string" form:"group_name,required"`
	UID       *int64  `thrift:"UID,2,optional" frugal:"2,optional,i64" json:"UID,omitempty"`
}

func NewCreateChatGroupReq() *CreateChatGroupReq {
	return &CreateChatGroupReq{}
}

func (p *CreateChatGroupReq) InitDefault() {
	*p = CreateChatGroupReq{}
}

var CreateChatGroupReq_GroupName_DEFAULT string

func (p *CreateChatGroupReq) GetGroupName() (v string) {
	if !p.IsSetGroupName() {
		return CreateChatGroupReq_GroupName_DEFAULT
	}
	return *p.GroupName
}

var CreateChatGroupReq_UID_DEFAULT int64

func (p *CreateChatGroupReq) GetUID() (v int64) {
	if !p.IsSetUID() {
		return CreateChatGroupReq_UID_DEFAULT
	}
	return *p.UID
}
func (p *CreateChatGroupReq) SetGroupName(val *string) {
	p.GroupName = val
}
func (p *CreateChatGroupReq) SetUID(val *int64) {
	p.UID = val
}

var fieldIDToName_CreateChatGroupReq = map[int16]string{
	1: "GroupName",
	2: "UID",
}

func (p *CreateChatGroupReq) IsSetGroupName() bool {
	return p.GroupName != nil
}

func (p *CreateChatGroupReq) IsSetUID() bool {
	return p.UID != nil
}

func (p *CreateChatGroupReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateChatGroupReq[fieldId]), err)
SkipFieldError:
...
func (p *CreateChatGroupReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CreateChatGroupReq) ReadField2(iprot thrift.TProtocol) error {
...
func (p *CreateChatGroupReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateChatGroupReq"); err != nil {
...
func (p *CreateChatGroupReq) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetGroupName() {
...
func (p *CreateChatGroupReq) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetUID() {
...
func (p *CreateChatGroupReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CreateChatGroupReq(%+v)", *p)

}

func (p *CreateChatGroupReq) DeepEqual(ano *CreateChatGroupReq) bool {
	if p == ano {
		return true
...
func (p *CreateChatGroupReq) Field1DeepEqual(src *string) bool {

	if p.GroupName == src {
		return true
	} else if p.GroupName == nil || src == nil {
		return false
	}
...
func (p *CreateChatGroupReq) Field2DeepEqual(src *int64) bool {
...
type CreateChatGroupResp struct {
	GroupID *int64 `thrift:"GroupID,1,optional" frugal:"1,optional,i64" json:"group_id"`
}

func NewCreateChatGroupResp() *CreateChatGroupResp {
	return &CreateChatGroupResp{}
}

func (p *CreateChatGroupResp) InitDefault() {
	*p = CreateChatGroupResp{}
}

var CreateChatGroupResp_GroupID_DEFAULT int64

func (p *CreateChatGroupResp) GetGroupID() (v int64) {
	if !p.IsSetGroupID() {
		return CreateChatGroupResp_GroupID_DEFAULT
	}
	return *p.GroupID
}
func (p *CreateChatGroupResp) SetGroupID(val *int64) {
	p.GroupID = val
}

var fieldIDToName_CreateChatGroupResp = map[int16]string{
	1: "GroupID",
}

func (p *CreateChatGroupResp) IsSetGroupID() bool {
	return p.GroupID != nil
}

func (p *CreateChatGroupResp) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateChatGroupResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CreateChatGroupResp) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CreateChatGroupResp) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateChatGroupResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CreateChatGroupResp) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetGroupID() {
...
func (p *CreateChatGroupResp) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CreateChatGroupResp(%+v)", *p)

}

func (p *CreateChatGroupResp) DeepEqual(ano *CreateChatGroupResp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *CreateChatGroupResp) Field1DeepEqual(src *int64) bool {
...
type RelationService interface {
	CreateChatGroup(ctx context.Context, req *CreateChatGroupReq) (r *CreateChatGroupResp, err error)
...
func (p *RelationServiceClient) CreateChatGroup(ctx context.Context, req *CreateChatGroupReq) (r *CreateChatGroupResp, err error) {
	var _args RelationServiceCreateChatGroupArgs
	_args.Req = req
	var _result RelationServiceCreateChatGroupResult
	if err = p.Client_().Call(ctx, "CreateChatGroup", &_args, &_result); err != nil {
		return
	}
...
func NewRelationServiceProcessor(handler RelationService) *RelationServiceProcessor {
	...
	self.AddToProcessorMap("CreateChatGroup", &relationServiceProcessorCreateChatGroup{handler: handler})
...
type relationServiceProcessorCreateChatGroup struct {
	handler RelationService
}

func (p *relationServiceProcessorCreateChatGroup) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := RelationServiceCreateChatGroupArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("CreateChatGroup", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := RelationServiceCreateChatGroupResult{}
	var retval *CreateChatGroupResp
	if retval, err2 = p.handler.CreateChatGroup(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing CreateChatGroup: "+err2.Error())
		oprot.WriteMessageBegin("CreateChatGroup", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("CreateChatGroup", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
type RelationServiceCreateChatGroupArgs struct {
	Req *CreateChatGroupReq `thrift:"req,1" frugal:"1,default,CreateChatGroupReq" json:"req"`
}

func NewRelationServiceCreateChatGroupArgs() *RelationServiceCreateChatGroupArgs {
	return &RelationServiceCreateChatGroupArgs{}
}

func (p *RelationServiceCreateChatGroupArgs) InitDefault() {
	*p = RelationServiceCreateChatGroupArgs{}
}

var RelationServiceCreateChatGroupArgs_Req_DEFAULT *CreateChatGroupReq

func (p *RelationServiceCreateChatGroupArgs) GetReq() (v *CreateChatGroupReq) {
	if !p.IsSetReq() {
		return RelationServiceCreateChatGroupArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *RelationServiceCreateChatGroupArgs) SetReq(val *CreateChatGroupReq) {
	p.Req = val
}

var fieldIDToName_RelationServiceCreateChatGroupArgs = map[int16]string{
	1: "req",
}

func (p *RelationServiceCreateChatGroupArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *RelationServiceCreateChatGroupArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationServiceCreateChatGroupArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationServiceCreateChatGroupArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewCreateChatGroupReq()
...
func (p *RelationServiceCreateChatGroupArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateChatGroup_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RelationServiceCreateChatGroupArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *RelationServiceCreateChatGroupArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationServiceCreateChatGroupArgs(%+v)", *p)

}

func (p *RelationServiceCreateChatGroupArgs) DeepEqual(ano *RelationServiceCreateChatGroupArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *RelationServiceCreateChatGroupArgs) Field1DeepEqual(src *CreateChatGroupReq) bool {
...
type RelationServiceCreateChatGroupResult struct {
	Success *CreateChatGroupResp `thrift:"success,0,optional" frugal:"0,optional,CreateChatGroupResp" json:"success,omitempty"`
}

func NewRelationServiceCreateChatGroupResult() *RelationServiceCreateChatGroupResult {
	return &RelationServiceCreateChatGroupResult{}
}

func (p *RelationServiceCreateChatGroupResult) InitDefault() {
	*p = RelationServiceCreateChatGroupResult{}
}

var RelationServiceCreateChatGroupResult_Success_DEFAULT *CreateChatGroupResp

func (p *RelationServiceCreateChatGroupResult) GetSuccess() (v *CreateChatGroupResp) {
	if !p.IsSetSuccess() {
		return RelationServiceCreateChatGroupResult_Success_DEFAULT
	}
	return p.Success
}
func (p *RelationServiceCreateChatGroupResult) SetSuccess(x interface{}) {
	p.Success = x.(*CreateChatGroupResp)
}

var fieldIDToName_RelationServiceCreateChatGroupResult = map[int16]string{
	0: "success",
}

func (p *RelationServiceCreateChatGroupResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RelationServiceCreateChatGroupResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationServiceCreateChatGroupResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationServiceCreateChatGroupResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewCreateChatGroupResp()
...
func (p *RelationServiceCreateChatGroupResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateChatGroup_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *RelationServiceCreateChatGroupResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *RelationServiceCreateChatGroupResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationServiceCreateChatGroupResult(%+v)", *p)

}

func (p *RelationServiceCreateChatGroupResult) DeepEqual(ano *RelationServiceCreateChatGroupResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *RelationServiceCreateChatGroupResult) Field0DeepEqual(src *CreateChatGroupResp) bool {
