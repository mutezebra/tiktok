...
type InfoResp struct {
	Data      *UserInfo                    `thrift:"Data,1,optional" frugal:"1,optional,UserInfo" json:"info"`
	Friends   *relation.GetFriendsListResp `thrift:"Friends,2,optional" frugal:"2,optional,relation.GetFriendsListResp" json:"friends"`
	Fans      *relation.GetFansListResp    `thrift:"Fans,3,optional" frugal:"3,optional,relation.GetFansListResp" json:"fans"`
	Follows   *relation.GetFollowListResp  `thrift:"Follows,4,optional" frugal:"4,optional,relation.GetFollowListResp" json:"follows"`
	VideoList *video.GetVideoListResp      `thrift:"VideoList,5,optional" frugal:"5,optional,video.GetVideoListResp" json:"video_list"`
	LikeList  *interaction.LikeListResp    `thrift:"LikeList,6,optional" frugal:"6,optional,interaction.LikeListResp" json:"like_list"`
}
...
var InfoResp_Friends_DEFAULT *relation.GetFriendsListResp

func (p *InfoResp) GetFriends() (v *relation.GetFriendsListResp) {
	if !p.IsSetFriends() {
		return InfoResp_Friends_DEFAULT
	}
	return p.Friends
}

var InfoResp_Fans_DEFAULT *relation.GetFansListResp

func (p *InfoResp) GetFans() (v *relation.GetFansListResp) {
	if !p.IsSetFans() {
		return InfoResp_Fans_DEFAULT
	}
	return p.Fans
}

var InfoResp_Follows_DEFAULT *relation.GetFollowListResp

func (p *InfoResp) GetFollows() (v *relation.GetFollowListResp) {
	if !p.IsSetFollows() {
		return InfoResp_Follows_DEFAULT
	}
	return p.Follows
}

var InfoResp_VideoList_DEFAULT *video.GetVideoListResp

func (p *InfoResp) GetVideoList() (v *video.GetVideoListResp) {
	if !p.IsSetVideoList() {
		return InfoResp_VideoList_DEFAULT
	}
	return p.VideoList
}

var InfoResp_LikeList_DEFAULT *interaction.LikeListResp

func (p *InfoResp) GetLikeList() (v *interaction.LikeListResp) {
	if !p.IsSetLikeList() {
		return InfoResp_LikeList_DEFAULT
	}
	return p.LikeList
}
...
func (p *InfoResp) SetFriends(val *relation.GetFriendsListResp) {
	p.Friends = val
}
func (p *InfoResp) SetFans(val *relation.GetFansListResp) {
	p.Fans = val
}
func (p *InfoResp) SetFollows(val *relation.GetFollowListResp) {
	p.Follows = val
}
func (p *InfoResp) SetVideoList(val *video.GetVideoListResp) {
	p.VideoList = val
}
func (p *InfoResp) SetLikeList(val *interaction.LikeListResp) {
	p.LikeList = val
}
...
func (p *InfoResp) IsSetFriends() bool {
	return p.Friends != nil
}

func (p *InfoResp) IsSetFans() bool {
	return p.Fans != nil
}

func (p *InfoResp) IsSetFollows() bool {
	return p.Follows != nil
}

func (p *InfoResp) IsSetVideoList() bool {
	return p.VideoList != nil
}

func (p *InfoResp) IsSetLikeList() bool {
	return p.LikeList != nil
}
...
func (p *InfoResp) ReadField4(iprot thrift.TProtocol) error {
...
func (p *InfoResp) ReadField5(iprot thrift.TProtocol) error {
...
func (p *InfoResp) ReadField6(iprot thrift.TProtocol) error {
...
func (p *InfoResp) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetFriends() {
		if err = oprot.WriteFieldBegin("Friends", thrift.STRUCT, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *InfoResp) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetFans() {
		if err = oprot.WriteFieldBegin("Fans", thrift.STRUCT, 3); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.Fans.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *InfoResp) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetFollows() {
		if err = oprot.WriteFieldBegin("Follows", thrift.STRUCT, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.Follows.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *InfoResp) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetVideoList() {
		if err = oprot.WriteFieldBegin("VideoList", thrift.STRUCT, 5); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *InfoResp) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetLikeList() {
		if err = oprot.WriteFieldBegin("LikeList", thrift.STRUCT, 6); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.LikeList.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *InfoResp) DeepEqual(ano *InfoResp) bool {
	...
	if !p.Field3DeepEqual(ano.Fans) {
		return false
	}
	if !p.Field4DeepEqual(ano.Follows) {
		return false
	}
	if !p.Field5DeepEqual(ano.VideoList) {
		return false
	}
	if !p.Field6DeepEqual(ano.LikeList) {
		return false
	}
	return true
}
...
func (p *InfoResp) Field2DeepEqual(src *relation.GetFriendsListResp) bool {

	if !p.Friends.DeepEqual(src) {
		return false
	}
	return true
}
func (p *InfoResp) Field3DeepEqual(src *relation.GetFansListResp) bool {

	if !p.Fans.DeepEqual(src) {
		return false
	}
	return true
}
func (p *InfoResp) Field4DeepEqual(src *relation.GetFollowListResp) bool {

	if !p.Follows.DeepEqual(src) {
		return false
	}
	return true
}
func (p *InfoResp) Field5DeepEqual(src *video.GetVideoListResp) bool {
...
func (p *InfoResp) Field6DeepEqual(src *interaction.LikeListResp) bool {

	if !p.LikeList.DeepEqual(src) {
		return false
	}
	return true
}
